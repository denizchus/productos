...
<body>
    ...
    <div class="container">
        ...
        <?php
               ...
               $id =$_POST['id'];
               $UpdateSQL="Update gastos set  descripcion ='$descripcion',cantidad='$cantidad',precio='$precio', fechaelabo='$fechaelabo', fechavenc='$fechavenc' where id = $id";
               ...
               if($conexion->query($UpdateSQL) === true){
                 ...
                 <p>
                     Los datos han sido actualizados, puede consultar la información de '.$descripcion.' '.$cantidad.' en la lista.
