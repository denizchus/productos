        ...
        <div class="row mt-5">
            <div class="card w-100">
                <div class="card-header">
                    <h4 class="card-title">Nueva Información de Productos</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" name="descripcion"
                                    placeholder="Por favor escriba la descripcion de producto" required>
                            </div>
                            <div class="form-group col-4">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="text" class="form-control" name="precio"
                                    placeholder="Por favor escriba el precio para el Producto" required>
                            </div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="date" name="fechaelabo" class="form-control" required> 
                            </div>
