    ...
    <div class="container">
        <div class="row mt-5">
            <?php
               ...
               $id =$_GET['id'];
               $UpdateSQL="delete from gastos where id = $id";
               if($conexion->query($UpdateSQL) === true){
                 echo '
                 <div class="alert alert-success w-100" role="alert">
                 <h4 class="alert-heading"> Información Eliminada</h4>
                 <p>
                     Los datos han sido eliminados, ya no parecera la informacion de '.$descripcion.' en la lista.
                 </p>
                 <center> <h1><i class="fas fa-user-times"></i></h1></center> 
                 <hr>
